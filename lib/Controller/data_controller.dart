...
////////////// get profile Data  //////////////////
  ...
  Future<void> createEvent(Map<String, dynamic> eventData) async {
    EasyLoading.dismiss();
    await firestore.collection('events').add(eventData).then((value) {
      CustomizedSnackBar("Event Uploaded", "Event is uploaded successfully");
    }).catchError((e) {
      EasyLoading.dismiss();
      CustomizedSnackBar("Event Uploaded Error", e);
    });
    // return isCompleted;
  }
